  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* Checkout Form or Sign In Prompt */}
        {!user ? (
          <div className="bg-white rounded-2xl shadow-2xl p-8 flex flex-col items-center justify-center text-center border border-warmBrown-100">
            ...
            <p className="font-sans text-warmBrown-600 mb-8 max-w-md">
              Please sign in with your Google account to complete your order. This helps us track your order and provide better service.
            </p>
            <SignInButton />
          </div>
        ) : (
